...
#define  FIRMWARE_VERSION_REVISION_CODE     104

#define  FIRMWARE_VERSION_HEX               (FIRMWARE_VERSION_MAJOR_CODE << 16 | FIRMWARE_VERSION_MINOR_CODE | FIRMWARE_VERSION_REVISION_CODE)
